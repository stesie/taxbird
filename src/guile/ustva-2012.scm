;; Copyright(C) 2004,2005,2006,2008,2009,2010,2011 Stefan Siegl <stesie@brokenpipe.de>
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define ustva-2012:definition
  '("Datenlieferant" ("datenlieferant.ui" "datenlieferant")
    
    "Finanzamtsverbindung" 	("ustva-2010-stammdaten.ui" "stammdaten")
    "Schnellerfassung"          ("ustva-2010-schnell.ui" "schnell")
    "Formular"		        ("ustva-2012-seite_1.ui" "seite_1")))




(define ustva-2012:validators
  (list 
   ...
   "Kz78" validate:signed-int
   "Kz79"
   (lambda (val buf)
     (let ((maximum (storage:retrieve buf "Kz78")))
       (validate:signed-monetary-max val buf maximum)))
...
(define ustva-2012:validate
  (lambda (buffer element value)
    (let ((func (member element ustva-2012:validators)))
      (if (not func)
	  (let ()
...
(define ustva-2012:recalculate
  (lambda (buffer element value)
    ...
    (let ((fields (list "uebertrag"  (list "Kz36" "Kz86-calc" "Kz81-calc"
					   ...
					   "Kz89-calc")
			"ust-sum"    (list "uebertrag" "Kz85" "Kz74" "Kz79" "Kz53" "Kz47"
					   "Kz65")
		 ...
		 (fields (list (lambda (val)
				 ...
				 (format #f "~D" (inexact->exact 
			       ...
			       (list "Kz21" "Kz35" "Kz41" "Kz42" "Kz43" "Kz44"
				     ...
				     "Kz76" "Kz73" "Kz77" "Kz78" "Kz81" "Kz84"
				     "Kz86" "Kz89" "Kz91" "Kz93" "Kz94" "Kz95"
...
(define ustva-2012:export-steuerfall
  (lambda (buffer sig-result)
    (list 
     ...
     (list "DatenLieferant"   #f 
	   ...
	   "Steuerfall"       #f (ustva-2012:export buffer sig-result)))))



(define ustva-2012:get-sheet
  (lambda (sheet-name)
    (tb:eval-file "sheettree.scm")

    (or (get-sheet sheet-name ustva-2012:definition))))
