;; Copyright(C) 2004,2005,2006,2010 Stefan Siegl <stesie@brokenpipe.de>
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
(define ustva-2007:definition
  '("Datenlieferant" ("datenlieferant.xml" "datenlieferant")
    
    "Finanzamtsverbindung" 	("ustva-2007.xml" "stammdaten")
    "Schnellerfassung"          ("ustva-2007.xml" "schnell")
    "Formular"		        ("ustva-2007.xml" "seite_1")))




(define ustva-2007:validators
  (list 
   ...
   "Kz81" validate:signed-int   ;; Ums. regulär, 19% USt ab 2007
   ...
   "Kz89" validate:signed-int   ;; Ums. innerg. Erw. 19% USt ab 2007
...
(define ustva-2007:validate
  (lambda (buffer element value)
    (let ((func (member element ustva-2007:validators)))
      (if (not func)
	  (let ()
...
(define ustva-2007:recalculate
  (lambda (buffer element value)
    (let ((list '(
		  ;; regulärer Umsatz, 19 % USt (ab 2007)
...
(define ustva-2007:export-steuerfall
  (lambda (buffer sig-result)
    (list 
     ...
     (list "DatenLieferant"   #f 
	   ...
	   "Steuerfall"       #f (ustva-2007:export buffer sig-result)))))



(define ustva-2007:get-sheet
  (lambda (sheet-name)
    (tb:eval-file "sheettree.scm")

    (or (get-sheet sheet-name ustva-2007:definition))))
