...
(and 
 (require-version 0 4 "Umsatzsteuervoranmeldung 2008")
 ...
 (tb:form-register
  ...
  (lambda ()
    ...
    (extract-sheet-tree ustva-2007:definition))   ;; forms of 2007 and 2008 are
                                                  ;; exactly the same
  ...
  (lambda (buf test)
	...
	(let ((sig-result (and (not test)
	  ...
	  (export:make-elster-xml
	   ...
	   (ustva-2008:export-steuerfall buf sig-result)))))
