...
(and 
 (require-version 0 4 "Umsatzsteuervoranmeldung 2009")
 (require-geier-version 0 10 "Umsatzsteuervoranmeldung 2009")
 ...
 (tb:form-register
  ...
  (lambda ()
    ...
    (extract-sheet-tree ustva-2007:definition))   ;; forms of 2007,08,09 are
                                                  ;; exactly the same
  ...
  (lambda (buf test)
	...
	(let ((sig-result (and (not test)
	  ...
	  (export:make-elster-xml
	   ...
	   (ustva-2009:export-steuerfall buf sig-result)))))
