...
(and 
 (require-version 0 4 "Antrag auf Dauerfristverlängerung 2012")
 (require-geier-version 0 12 "Antrag auf Dauerfristverlängerung 2012")
 
 ;; if version requirement is met, try to add the sheet ...
 (tb:form-register
  ;; form's name
  "Antrag auf Dauerfristverlängerung 2012" 
  ...
  (lambda (buf test)
	...
	(let ((sig-result (if test #f "00616")))
	  ...
	  (export:make-elster-xml
	   ...
	   (ustsvza-2012:export-steuerfall buf sig-result)))))
