...
(and 
 (require-version 0 4 "Antrag auf Dauerfristverlängerung 2008")

 ;; if version requirement is met, try to add the sheet ...
 (tb:form-register
  ;; form's name
  "Antrag auf Dauerfristverlängerung 2008" 
  ...
  (lambda (buf test)
	...
	(let ((sig-result (and (not test)
	  ...
	  (export:make-elster-xml
	   ...
	   (ustsvza-2008:export-steuerfall buf sig-result)))))
