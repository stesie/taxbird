...
(and 
 (require-version 0 4 "Antrag auf Dauerfristverlängerung 2010")
 (require-geier-version 0 10 "Antrag auf Dauerfristverlängerung 2010")
 
 ;; if version requirement is met, try to add the sheet ...
 (tb:form-register
  ;; form's name
  "Antrag auf Dauerfristverlängerung 2010" 
  ...
  (lambda (buf test)
	...
	(let ((sig-result (if test #f "00616")))
	  ...
	  (export:make-elster-xml
	   ...
	   (ustsvza-2010:export-steuerfall buf sig-result)))))
